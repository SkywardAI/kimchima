...
class SimpleGPTTrainer:
    ...
    @classmethod
    def split_to_train_validate(cls, text:torch.Tensor, train_frac:float)->tuple[torch.Tensor, torch.Tensor]:
        """
        Split the text into training and validation sets
        """
        data=torch.tensor(text, dtype=torch.long) # construct a tensor with no autograd history
    ...
    @classmethod
    def get_batch(cls, split:str, train_data:torch.Tensor, val_data:torch.Tensor)->tuple[torch.Tensor, torch.Tensor]:
        """
    ...
    @classmethod
    def train(cls, model:SimpleGPT, optimizer:torch.optim.Adam, train_data:torch.Tensor, val_data:torch.Tensor)->float:
        """
        Train the model
        """
